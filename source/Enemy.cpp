...
Polygon Enemy::createShape(cint r, cint g, cint b) {
    ...
    poly.addFace({{(unsigned char) (95 + r * 5 / 255),
                          (unsigned char) (95 + g * 5 / 255),
                          (unsigned char) (95 + b * 5 / 255)},
                  {{0, 1, 2}}});
    poly.addFace({{(unsigned char) (190 * r / 255),
                          (unsigned char) (200 * g / 255),
                          (unsigned char) (200 * b / 255)},
                  {{0, 1, 3}}});
    poly.addFace({{(unsigned char) (220 * r / 255),
                          (unsigned char) (220 * g / 255),
                          (unsigned char) (220 * b / 255)},
                  {{0, 2, 3}}});
    poly.addFace({{(unsigned char) (140 * r / 255),
                          (unsigned char) (160 * g / 255),
                          (unsigned char) (160 * b / 255)},
                  {{1, 2, 3}}});
    return poly;
}
